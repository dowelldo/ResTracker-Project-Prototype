...
echo "<form action=\"try.php\" method=\"GET\" id=\"editform\">";
...
{ 
	...
	. "</td><td>" . $row['type'] 
	. "</td><td>" . $row['serv_size'] 
	. "</td><td>" . "<a href=\"http://student2.cs.appstate.edu/teams/4800-191-t1/restracker/website/update.php?itemname=chicken&itemtype=Inventory\"><span class=\"glyphicon glyphicon-eye-open\"></span>	Edit</a>"
    . "</td><td>" . "<a href=\"http://student2.cs.appstate.edu/teams/4800-191-t1/restracker/website/checkinvent.html\"><span class=\"glyphicon glyphicon-eye-open\"></span>	Remove</a>" 
	. "</td></tr>"; 
