...
$pdf->Cell(0,8,'OVERALL INVENTORY',0,1,'L');
...
$sql = mysqli_query($conn, "SELECT * FROM Recipe");
$pdf->SetFont('Arial','B',12);
$pdf->Cell(0,8,'RECIPE BOOK',0,1,'L');
$pdf->Cell(36,8,'Name',1,0,'C');
$pdf->Cell(23,8,'Type',1,0,'C');
$pdf->Cell(25,8,'Measuring',1,0,'C');
$pdf->Cell(23,8,'Serv. Size',1,0,'C');
$pdf->Cell(92,8,'Ingredients',1,1,'C');
...
while ($row = mysqli_fetch_array($sql))
{
	...
	$pdf->Cell(23,8,$row['type'],1,0,'C');
	//$pdf->Cell(20,12,1,1,1,'C');
	$pdf->Cell(25,8,$row['measuring'],1,0,'C');
	$pdf->Cell(23,8,$row['serv_size'],1,0,'C');
	$pdf->Cell(92,8,$row['description'],1,1,'C');
